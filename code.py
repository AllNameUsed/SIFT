import cv2
import numpy as np
# from helper import ransac_calibrate
...
def getMatches(image1, image2, features, ransac_iterations = 150, dist_threshold = 0.8):
    ...
    cv2.imwrite("all_matches.png",Matched)
...
if __name__ =="__main__":
    ...
    showAndWrite(out, temp, path ="output.png")